        ...
        <View style = {Styles.Container}>
            <View style ={Styles.pageContainer}>
                <View style={{alignItems: "center"}}>
                    <Image source = {require("../../assets/Home/Profile.png")} style={{marginTop: -60}}/>
                </View>
                ...
                <View style={Styles.Details}>
                    <View style={Styles.PersonDetail}>
                        ...
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 15, marginLeft: 40, marginTop:15}}>xyg@gmail.com</Text> 
                            <TouchableOpacity onPress={()=> {alert('Hello')}}>
                                <Text style={{marginLeft:"38%", marginTop: -10, fontSize:18, color:"#162593", fontWeight:"bold"}}>EDIT</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <View style={Styles.Address}>
                        ...
                        <Text style={{marginTop: 10, marginRight: 40}}>no 24, 2nd cross, BHCS Layout, padmanabanagar, Banglore-23</Text>
                        <TouchableOpacity onPress={() => alert('Hello')}>
                            <Text style={{marginLeft:"86%", marginTop: -50, fontSize:18, color:"#162593", fontWeight:"bold"}}>EDIT</Text>
                        </TouchableOpacity>
                    </View>
